...
import com.example.cloverchatserver.chat.user.service.DuplicatedChatUserException
import com.example.cloverchatserver.chat.user.service.NotFoundChatUserException
...
@RestControllerAdvice(assignableTypes = [ ChatUserController::class ])
